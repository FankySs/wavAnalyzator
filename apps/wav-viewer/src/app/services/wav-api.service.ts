...
export class WavApiService {
  ...
  getWavList(): Observable<WavFileDto[]> {
    return this.http
      .get<WavFileDto[]>(`${this.base}/api/wav`)
  ...
  uploadWav(file: File): Observable<WavFileDto> {
    ...
    return this.http
      .post<WavFileDto>(`${this.base}/api/wav/upload`, form)
      .pipe(catchError(this.handleError));
  }
  ...
  deleteWav(id: string): Observable<void> {
    return this.http
      .delete<void>(`${this.base}/api/wav/${id}`)
      .pipe(catchError(this.handleError));
  }
  ...
  getChunks(id: string): Observable<WavChunkDto[]> {
    return this.http
      .get<WavChunkDto[]>(`${this.base}/api/wav/${id}/chunks`)
      .pipe(catchError(this.handleError));
  }

  getChunkDetail(id: string, chunkId: string): Observable<WavChunkDetailDto> {
    return this.http
      .get<WavChunkDetailDto>(`${this.base}/api/wav/${id}/chunks/${chunkId}`)
      .pipe(catchError(this.handleError));
  }

  deleteChunk(fileId: string, chunkId: string): Observable<void> {
    return this.http
      .delete<void>(`${this.base}/api/wav/${fileId}/chunks/${chunkId}`)
      .pipe(catchError(this.handleError));
  }
  ...
  updateListInfo(fileId: string, chunkDbId: string, dto: UpdateListInfoDto): Observable<WavChunkDetailDto> {
    return this.http
      .put<WavChunkDetailDto>(`${this.base}/api/wav/${fileId}/chunks/${chunkDbId}/info`, dto)
      .pipe(catchError(this.handleError));
  }

  addInfoEntry(fileId: string, chunkDbId: string, dto: CreateInfoEntryDto): Observable<WavChunkDetailDto> {
    return this.http
      .post<WavChunkDetailDto>(`${this.base}/api/wav/${fileId}/chunks/${chunkDbId}/info`, dto)
      .pipe(catchError(this.handleError));
  }
  ...
  deleteInfoEntry(fileId: string, chunkDbId: string, tagId: string): Observable<WavChunkDetailDto> {
    return this.http
      .delete<WavChunkDetailDto>(
        `${this.base}/api/wav/${fileId}/chunks/${chunkDbId}/info/${tagId}`,
      )
      .pipe(catchError(this.handleError));
  }
  ...
  updateBext(fileId: string, chunkDbId: string, dto: UpdateBextDto): Observable<WavChunkDetailDto> {
    return this.http
      .put<WavChunkDetailDto>(`${this.base}/api/wav/${fileId}/chunks/${chunkDbId}/bext`, dto)
      .pipe(catchError(this.handleError));
  }
  ...
  updateInst(fileId: string, chunkDbId: string, dto: UpdateInstDto): Observable<WavChunkDetailDto> {
    return this.http
      .put<WavChunkDetailDto>(`${this.base}/api/wav/${fileId}/chunks/${chunkDbId}/inst`, dto)
      .pipe(catchError(this.handleError));
  }

  updateSmpl(fileId: string, chunkDbId: string, dto: UpdateSmplDto): Observable<WavChunkDetailDto> {
    return this.http
      .put<WavChunkDetailDto>(`${this.base}/api/wav/${fileId}/chunks/${chunkDbId}/smpl`, dto)
      .pipe(catchError(this.handleError));
  }

  updateCue(fileId: string, chunkDbId: string, dto: UpdateCueDto): Observable<WavChunkDetailDto> {
    return this.http
      .put<WavChunkDetailDto>(`${this.base}/api/wav/${fileId}/chunks/${chunkDbId}/cue`, dto)
      .pipe(catchError(this.handleError));
  }
  ...
  createListInfo(fileId: string, dto: CreateListInfoDto): Observable<WavChunkDto> {
    return this.http
      .post<WavChunkDto>(`${this.base}/api/wav/${fileId}/chunks/list-info`, dto)
      .pipe(catchError(this.handleError));
  }

  createBext(fileId: string, dto: CreateBextDto): Observable<WavChunkDto> {
    return this.http
      .post<WavChunkDto>(`${this.base}/api/wav/${fileId}/chunks/bext`, dto)
      .pipe(catchError(this.handleError));
  }

  createCue(fileId: string, dto: CreateCueDto): Observable<WavChunkDto> {
    return this.http
      .post<WavChunkDto>(`${this.base}/api/wav/${fileId}/chunks/cue`, dto)
      .pipe(catchError(this.handleError));
  }

  createFact(fileId: string, dto: CreateFactDto): Observable<WavChunkDto> {
    return this.http
      .post<WavChunkDto>(`${this.base}/api/wav/${fileId}/chunks/fact`, dto)
      .pipe(catchError(this.handleError));
  }

  createInst(fileId: string, dto: CreateInstDto): Observable<WavChunkDto> {
    return this.http
      .post<WavChunkDto>(`${this.base}/api/wav/${fileId}/chunks/inst`, dto)
      .pipe(catchError(this.handleError));
  }

  createSmpl(fileId: string, dto: CreateSmplDto): Observable<WavChunkDto> {
    return this.http
      .post<WavChunkDto>(`${this.base}/api/wav/${fileId}/chunks/smpl`, dto)
      .pipe(catchError(this.handleError));
  }

  createCart(fileId: string, dto: CreateCartDto): Observable<WavChunkDto> {
    return this.http
      .post<WavChunkDto>(`${this.base}/api/wav/${fileId}/chunks/cart`, dto)
      .pipe(catchError(this.handleError));
  }

  createDisp(fileId: string, dto: CreateDispDto): Observable<WavChunkDto> {
    return this.http
      .post<WavChunkDto>(`${this.base}/api/wav/${fileId}/chunks/disp`, dto)
      .pipe(catchError(this.handleError));
  }

  createIxml(fileId: string, dto: CreateIxmlDto): Observable<WavChunkDto> {
    return this.http
      .post<WavChunkDto>(`${this.base}/api/wav/${fileId}/chunks/ixml`, dto)
      .pipe(catchError(this.handleError));
  }

  createAxml(fileId: string, dto: CreateAxmlDto): Observable<WavChunkDto> {
    return this.http
      .post<WavChunkDto>(`${this.base}/api/wav/${fileId}/chunks/axml`, dto)
      .pipe(catchError(this.handleError));
  }

  createAdtl(fileId: string, dto: CreateAdtlDto): Observable<WavChunkDto> {
    return this.http
      .post<WavChunkDto>(`${this.base}/api/wav/${fileId}/chunks/adtl`, dto)
      .pipe(catchError(this.handleError));
  }

  downloadWav(id: string): Observable<Blob> {
    return this.http
      .get(`${this.base}/api/wav/${id}/download`, { responseType: 'blob' })
      .pipe(catchError(this.handleError));
  }

  getWaveform(id: string, width: number): Observable<WaveformDto> {
    return this.http
      .get<WaveformDto>(`${this.base}/api/wav/${id}/waveform`, { params: { width: String(width) } })
      .pipe(catchError(this.handleError));
  }

  getStreamUrl(id: string): string {
    return `${this.base}/api/wav/${id}/stream`;
  }
