...
const CART_HIGHLIGHTS: ChunkHighlight[] = [
  ...
  { label: 'Artist',         byteOffset: 76,   byteLength: 64,   color: 'var(--highlight-10)',        description: 'Artist (64 ASCII characters)' },
  { label: 'Cut ID',         byteOffset: 140,  byteLength: 64,   color: 'var(--highlight-2)',        description: 'Cut identifier (64 ASCII characters)' },
  { label: 'Client ID',      byteOffset: 204,  byteLength: 64,   color: 'var(--highlight-6)',        description: 'Client identifier (64 ASCII characters)' },
  { label: 'Category',       byteOffset: 268,  byteLength: 64,   color: 'var(--highlight-8)',        description: 'Recording category (64 ASCII characters)' },
  { label: 'Classification', byteOffset: 332,  byteLength: 64,   color: 'var(--highlight-3)',        description: 'Classification (64 ASCII characters)' },
  { label: 'Out Cue',        byteOffset: 396,  byteLength: 64,   color: 'var(--highlight-9)',        description: 'Out cue text (64 ASCII characters)' },
  { label: 'Start Date',     byteOffset: 460,  byteLength: 10,   color: 'var(--highlight-1)',        description: 'Start validity date (YYYY-MM-DD)' },
  { label: 'Start Time',     byteOffset: 470,  byteLength: 8,    color: 'var(--highlight-7)',        description: 'Start validity time (HH:MM:SS)' },
  { label: 'End Date',       byteOffset: 478,  byteLength: 10,   color: 'var(--highlight-5)',        description: 'End validity date (YYYY-MM-DD)' },
  { label: 'End Time',       byteOffset: 488,  byteLength: 8,    color: 'var(--highlight-3)',        description: 'End validity time (HH:MM:SS)' },
  { label: 'Producer App',   byteOffset: 496,  byteLength: 64,   color: 'var(--highlight-4)',        description: 'Name of the application that created the file (64 characters)' },
  { label: 'Producer Ver',   byteOffset: 560,  byteLength: 64,   color: 'var(--highlight-11)',        description: 'Application version (64 characters)' },
  { label: 'User Def',       byteOffset: 624,  byteLength: 64,   color: 'var(--highlight-12)',        description: 'User-defined field (64 characters)' },
  { label: 'Level Ref',      byteOffset: 688,  byteLength: 4,    color: 'var(--warning)', description: 'Reference level in dB × 100 (int32)' },
  { label: 'Post Timer',     byteOffset: 692,  byteLength: 128,  color: 'var(--highlight-10)',        description: '8 post-timer records of 16 bytes each (usage 4B + value 4B × 2)' },
  { label: 'Reserved',       byteOffset: 820,  byteLength: 276,  color: 'var(--muted)',   description: 'Reserved fields' },
  { label: 'URL',            byteOffset: 1096, byteLength: 1024, color: 'var(--highlight-2)',        description: 'URL link (1024 ASCII characters)' },
  { label: 'Tag Text',       byteOffset: 2120, byteLength: -1,   color: 'var(--highlight-6)',        description: 'Free text with tags (variable length)' },
];
