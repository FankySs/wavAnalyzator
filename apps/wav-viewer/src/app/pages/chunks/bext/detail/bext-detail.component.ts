...
const BEXT_HIGHLIGHTS: ChunkHighlight[] = [
  ...
  { label: 'Originator Ref',   byteOffset: 296, byteLength: 32,  color: 'var(--highlight-10)',        description: 'Unique originator reference (32 characters)' },
  { label: 'Origination Date', byteOffset: 328, byteLength: 10,  color: 'var(--highlight-2)',        description: 'Creation date in YYYY-MM-DD format (10 ASCII characters)' },
  { label: 'Origination Time', byteOffset: 338, byteLength: 8,   color: 'var(--highlight-6)',        description: 'Creation time in HH-MM-SS format (8 ASCII characters)' },
  { label: 'Time Reference',   byteOffset: 346, byteLength: 8,   color: 'var(--highlight-8)',        description: 'Time reference from midnight in samples (uint64, little-endian)' },
  { label: 'Version',          byteOffset: 354, byteLength: 2,   color: 'var(--highlight-3)',        description: 'BWF standard version (uint16)' },
  { label: 'UMID',             byteOffset: 356, byteLength: 64,  color: 'var(--highlight-9)',        description: 'Unique Material Identifier per SMPTE 330M (64 bytes)' },
  { label: 'Loudness Value',   byteOffset: 420, byteLength: 2,   color: 'var(--highlight-1)',        description: 'Integrated loudness in LUFS × 100 (int16)' },
  { label: 'Loudness Range',   byteOffset: 422, byteLength: 2,   color: 'var(--highlight-7)',        description: 'Loudness range LRA × 100 (uint16)' },
  { label: 'Max True Peak',    byteOffset: 424, byteLength: 2,   color: 'var(--highlight-5)',        description: 'Maximum True Peak Level × 100 (int16)' },
  { label: 'Max Momentary',    byteOffset: 426, byteLength: 2,   color: 'var(--highlight-3)',        description: 'Maximum momentary loudness × 100 (int16)' },
  { label: 'Max Short Term',   byteOffset: 428, byteLength: 2,   color: 'var(--highlight-4)',        description: 'Maximum short-term loudness × 100 (int16)' },
  { label: 'Reserved',         byteOffset: 430, byteLength: 180, color: 'var(--muted)',   description: 'Reserved – must be zeros (180 bytes)' },
  { label: 'Coding History',   byteOffset: 610, byteLength: -1,  color: 'var(--highlight-11)',        description: 'Coding history – free text describing signal processing' },
];
